...
namespace ETM.BusinessLogicLayer.Services
{
    public class BaseStockService
    {
        ...
        static BaseStockService()
        {
            _nounce = Helpers.GetTimestamp();
        }       

        protected async Task<string> ApiQueryAsync(string apiName, IDictionary<string, string> req)
            {
        ...
        protected string ApiQuery(string apiName, IDictionary<string, string> req)
        {
